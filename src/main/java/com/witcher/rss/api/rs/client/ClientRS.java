...
import static com.witcher.rss.domain.util.Preconditions.webApplicationException;
...
public class ClientRS {
    ...
    @GET
    @Path("/news")
    public ResultResponse<Collection<NewsData>> getNewsByThemeIds(@QueryParam("ids") List<Long> themeIds) {
